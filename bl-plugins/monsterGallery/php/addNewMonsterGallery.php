...
<select name="modules" class="modules" style="width:100%;margin-bottom: 10px;box-sizing: border-box;padding: 6px;font-size:13px;">
  <option value="MediaJs">MediaJs</option>
...
placeholder="1400" value="<?php echo @$quality?>" pattern="[0-9]+">
</div>

<div style="grid-column:2/3">
<p style="margin:0;padding:0;">Width thumbnails in px</p>
<input type="" name="width" pattern="[0-9]+" style="width:100%;padding:5px;box-sizing: border-box;font-size:12px;" required  placeholder="1400" value="<?php echo @$width?>">
</div>


<div style="grid-column: 3/4;">
<p style="margin: 0;padding:0;">height thumbnails in px</p>
<input type="" name="height" pattern="[0-9]+" style="width:100%;padding:5px;box-sizing: border-box;font-size:12px;" required  placeholder="600" value="<?php echo @$height ;?>">
